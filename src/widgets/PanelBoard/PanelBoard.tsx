...
const PanelBoard = () => {
  return (
    <motion.div className="w-130  flex flex-col justify-between rounded-3xl overflow-hidden shadow-panel">
            ...
            <div className="w-full h-full flex gap-4 px-[1rem] items-center">
              <PanelCard>
                ...
                <div className="h-2/3 flex justify-center items-center pb-[2rem]">
                  <p className="font-sfprosemi text-panel-green text-semibold text-[20px]">Активен</p>
                </div>
              </PanelCard>
              <PanelCard>
                <div className="h-1/3">
                ...
                <div className="h-2/3 flex justify-center items-center pb-[2rem]">
                  <p className="font-sfprosemi text-panel-text-blue text-semibold text-[20px]">69%</p>
                </div>
              </PanelCard>
              <PanelCard>
                <div className="h-1/3">
                ...
                <motion.div className="h-2/3 flex justify-center items-center pb-[2rem]">
